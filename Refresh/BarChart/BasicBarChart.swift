...
class BasicBarChart: UIView {
    ...
    private let presenter = BasicBarChartPresenter(barWidth: 20, space: 30)
    ...
    private func showEntry(index: Int, entry: BasicBarEntry, animated: Bool, oldEntry: BasicBarEntry?) {
        ...
        mainLayer.addTextLayer(frame: entry.textValueFrame, color: cgColor, fontSize: 12, text: entry.data.textValue, animated: animated, oldFrame: oldEntry?.textValueFrame)
